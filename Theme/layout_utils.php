 ...
 ********************************************************************************/
/*********************************************************************************
 * $Header: /cvsroot/sugarcrm/sugarcrm/themes/Amazon/layout_utils.php,v 1.13 2004/09/01 01:38:35 jostrow Exp $
...
if ($show_help==true) {
     ...
     $the_form .= "<td class='bodySmall' align='right'>[ <A href='http://www.sugarcrm.com/home/component/option,com_docman' target='_blank'>".$app_strings['LNK_HELP']."</A> ]</td>\n";
}
...
if ($show_help) {
    ...
    $the_title .= "<td class='bodySmall' nowrap align='right'>[ <A href='http://www.sugarcrm.com/home/component/option,com_docman' target='_blank'>".$app_strings['LNK_HELP']."</A> ]</td>\n";
}
else {
