...
<table align="center" width="100%" border="0" cellpadding="5" cellspacing="2">
  <tr>
    <td align="right" colspan="3">
      ...
      <small><a href="<?=$PHP_SELF;?>?module=<?=$module;?>&PATFAM=0&PATEDIT=1&PAT_ID=0&I=2&EDIT=Y&NEW=Y">ADD NEW PATENT</a></small></td>
  </tr>
  <tr bgcolor=EEEEEE>
...
<table align="right" border="0" cellpadding="0" cellspacing="0"><tr>
  <td width="100%" align="center" bgcolor="#FFFFFF">
    ...
    if ($PAT_ID!="0"){?>&nbsp;|&nbsp;
    <a href="delete_confirm.php?module=<?=$module;?>&TABLE=pat_filings&ID=<?=$PAT_ID;?>&NAME=<?=$docket;?>">Delete</a>
    <?}?></td></tr>
</table><br><br>
...
<p> To view patent records, click <a href="patents_list.php?module=<?=$module;?>&SORT=ALL">here</a></p>
